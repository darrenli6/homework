...
export interface BoxInterface extends utils.Interface {
  ...
  events: {
    ...
    "valueChange(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "valueChange"): EventFragment;
}
...
export type valueChangeEvent = TypedEvent<[BigNumber], { newvalue: BigNumber }>;

export type valueChangeEventFilter = TypedEventFilter<valueChangeEvent>;
...
export interface Box extends BaseContract {
  ...
  filters: {
    ...
    "valueChange(uint256)"(newvalue?: null): valueChangeEventFilter;
    valueChange(newvalue?: null): valueChangeEventFilter;
  };
